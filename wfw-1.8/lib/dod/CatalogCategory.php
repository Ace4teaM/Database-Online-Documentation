    ...
    */
    public static function update(&$inst,$db=null){
      ...
      //execute la requete
       ...
       $query .= " catalog_category_id =".$db->parseValue($inst->catalogCategoryId).",";
       $query .= " category_desc =".$db->parseValue($inst->categoryDesc).",";
       $query .= " item_type =".$db->parseValue($inst->itemType).",";
       $query = substr($query,0,-1);//remove last ','
